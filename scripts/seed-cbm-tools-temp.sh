...
#
# Usage:
#   ADMIN_USERNAME=your@email.com ADMIN_PASSWORD=yourpass ./scripts/seed-cbm-tools.sh
#
...
#   AIWM_BASE_URL - AIWM service URL (default: https://api.x-or.cloud/dev/aiwm)
#   CBM_BASE_URL - CBM service URL (default: https://api.x-or.cloud/dev/cbm)
# ===================================
...
if [ -z "$ADMIN_USERNAME" ] || [ -z "$ADMIN_PASSWORD" ]; then
  echo -e "${RED}✗ Error: ADMIN_USERNAME and ADMIN_PASSWORD environment variables are required${NC}"
  echo ""
  echo "Usage:"
  echo "  ADMIN_USERNAME=your@email.com ADMIN_PASSWORD=yourpass ./scripts/seed-cbm-tools.sh"
  echo ""
  exit 1
fi
