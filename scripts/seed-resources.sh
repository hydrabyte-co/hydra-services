...
# Seed Example Resources Script
# Usage: ./scripts/seed-resources.sh
...
echo "========================================="
echo "Seeding Example Resources"
echo "========================================="
...
mongosh "${MONGO_URI}" --quiet < "$(dirname "$0")/seed-example-resources.js"
